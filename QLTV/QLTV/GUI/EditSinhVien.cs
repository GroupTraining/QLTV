...
namespace QLTV.GUI
{
    public partial class EditSinhVien : Form
    {
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn sửa  thông tin sinh viên không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        {
            if (MessageBox.Show("Bạn có muốn xóa  thông tin sinh viên không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
